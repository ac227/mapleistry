...
![p1](./images/atom-and-elements/Electronic-cloud-image-s-p.jpg)

s和p的电子云图像

![p2](./images/atom-and-elements/Electronic-cloud-image-d.jpg)
...
![p3](./images/atom-and-elements/Pauling-scale-1.jpg)
![p4](./images/atom-and-elements/Pauling-scale-2.jpg)
...
> 
> **Rahm标度（2019修正）**：基于平均价电子结合能，覆盖 1-96 元素（包括 $f$ 区）。图 1 显示周期表式数值（如 $H$ 13.6, $He$ 24.6, $Li$ 5.4 等）。解释 $f$ 区化合物键极性（如 $CoSb_3$, $Ca_3Hg_2$, $Th\text{-}Al$），但无法解释某些键极性（如 $H_2S$）。优势：统一方法，指导材料设计
